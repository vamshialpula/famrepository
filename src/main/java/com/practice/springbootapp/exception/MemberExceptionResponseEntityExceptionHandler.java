...
/**
 * @author vamshialpula
 * @RestController  : Returns response in case of Exception
 * @ControllerAdvice : Shares Exception Handling, Across all the Controllers
 */

@ControllerAdvice
@RestController
public class MemberExceptionResponseEntityExceptionHandler extends ResponseEntityExceptionHandler {
